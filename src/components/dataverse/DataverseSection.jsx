...
const COMPETITIONS = [
    ...
    { name: "CV Competition", earlyBird: 500, normal: 1000, teamSize: 3, category: "ai", icon: "CV", color: "from-green-500 to-emerald-500" },
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                >
                    <div className="text-center mb-10">
                        ...
                        <p className="text-gray-400 max-w-2xl mx-auto">Choose from 10 exciting competitions across various domains</p>
                    </div>
